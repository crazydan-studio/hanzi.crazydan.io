...
// 「折」拆分为 折/提/钩 三组（钩: 含钩的复合笔；提: 含提的复合笔）
export const STROKE_TYPE_GROUPS = [
  ...
  { name: '折', codes: [                        // 横竖系折笔与撇折/撇点
    7, 8, 12, 13, 17, 19, 21, 23, 25, 26, 28, 29
  ] },
  { name: '提', codes: [6, 11, 20] },          // 提/横折提/竖提
  { name: '钩', codes: [                        // 含钩的复合笔
    9, 10, 14, 15, 16, 18, 22, 24, 27, 30, 31, 32
  ] }
